...
```
Creates the eval definition file at `.codex/evals/feature-name.md`

### During Implementation
```
Re-run the checks recorded for `feature-name`
```
Runs current evals and reports status

### Post-Implementation
```
Write or refresh the eval report for `feature-name`
```
