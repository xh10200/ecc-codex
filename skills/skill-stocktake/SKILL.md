---
description: "Use when auditing Codex skills and local workflow surfaces for quality. Supports Quick Scan (changed skills only) and Full Stocktake modes with sequential subagent batch evaluation."
origin: ECC
---

# skill-stocktake

Audits Codex skills and local workflow surfaces using a quality checklist plus holistic AI judgment. Supports two modes: Quick Scan for recently changed skills, and Full Stocktake for a complete review.
...
| Full Stocktake | `results.json` absent, or explicit full run | 20–30 min |
