...
Use Codex or another judge model to evaluate open-ended outputs:
```markdown
[MODEL GRADER PROMPT]
...
### Pre-Implementation
Create `.codex/evals/feature-name.md` with capability checks, regression checks, and success metrics.

### During Implementation
Re-run the relevant build, test, and scenario checks recorded in the eval definition and update the status inline.

### Post-Implementation
Write or refresh `.codex/evals/feature-name.log` with the latest run results and summarize them in your close-out.
